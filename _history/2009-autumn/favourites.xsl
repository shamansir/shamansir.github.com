...
<!--    xmlns="http://www.w3.org/1999/xhtml" -->
  ...
  <xsl:output method="xml"
	...
	<xsl:template match="/f:favourites">
	    <div id="favourites-list"> <!-- Safari requires the only one root for the result XML -->
		<xsl:if test="./f:music">
		    <span class="favourites-label" id="favourites-music-group">Music:</span>
		...
		<xsl:if test="./f:movies">
			<span class="favourites-label" id="favourites-movies-group">Movies:</span>
		...
		<xsl:if test="./f:games">
			<span class="favourites-label" id="favourites-games-group">Games:</span>
		...
		<xsl:if test="./f:series-list">
			<span class="favourites-label" id="favourites-series-group">Series:</span>
		...
		<xsl:if test="./f:books">
			<span class="favourites-label" id="favourites-books-group">Books:</span>
