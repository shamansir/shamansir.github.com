var sectorsMap = {
    ...
    'resume': {
        ...
        xmlFile: 'resume-test', // FIXME: remove line 
        additionalHtml: '',
        icon: 'user_full_information_16'
    },
	'projects': {
		name: 'Projects',
		description: 'The projects I`ve done or doing or have taken part',
		additionalHtml: '',
        icon: 'server_16'
	},
	'occurences': {
...
function generateNavLinks() {
    ...
    for (sectorID in sectorsMap) {
        ...
        linkElm.href = XML_DATA_PATH + (sectorData.xmlFile ? 
                sectorData.xmlFile : sectorID) + '.xml';
