var urlByTypeMapping = {
	...
	"plurk": { address: "http://www.plurk.com/user/%id%", icon: "./icons/plurk.png", site: "http://www.plurk.com" }, 
	"sdf": { address: "http://%id%.freeshell.org", icon: "./icons/sdf.ico", site: "http://sdf.lonestar.org/" }       	
/* lastfm block */
